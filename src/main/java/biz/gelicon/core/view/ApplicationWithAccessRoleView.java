...
@Schema(description = "Представление 'Приложение с флагом доступа на роль'")
public class ApplicationWithAccessRoleView {
    ...
    public ApplicationWithAccessRoleView() {}
    ...
    public ApplicationWithAccessRoleView(Application entity) {
